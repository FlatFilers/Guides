...
[Listeners](/orchestration/listeners) to Flatfile.

Listeners are at the core of the Flatfile ecosystem, they are responsible for
picking up on [Events](/orchestration/events) and responding to them
accordingly.
...
When developing with Flatfile, listeners can [deployed](../deploying) to
...
<CardGroup cols={2}>
  ...
  ></Card>
  <Card
    title="Create a new isolated environment in dashboard"
    href="https://platform.flatfile.com"
  ></Card>
</CardGroup>
...
and undesirable consequences for your local listener. To avoid such
complications, it's advisable to keep your local environment separate from any
deployed code. This ensures optimal performance and helps maintain a stable
