...
{/* prettier-ignore */}
<Tooltip tip="Learn more about Environments">[Environments](/learning-center/architecture/environment)</Tooltip> are isolated entities and are intended to be a safe place to create and
