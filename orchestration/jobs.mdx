...
<ParamField path="metadata" type="string" optional>
  Additional metadata for the Job. You can store any additional information here.
</ParamField>
...
<Note>
  You can also use the [JobHandler Plugin](/plugins-docs/core/job-handler) which
