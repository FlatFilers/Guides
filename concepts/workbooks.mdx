...
A Workbook is comprised of one or more <Tooltip tip="A collection of fields that describe a single entity...">[Sheets](../blueprint/overview#terms)</Tooltip> plus any actions you want to take on those Sheets.
