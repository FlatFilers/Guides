...
#### `Labels` *array*
Give a workbook the label `pinned` for it to show up in first in the sidebar (with a pin icon!). You can add other custom labels to your workbooks as needed.
