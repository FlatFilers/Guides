...
A Workbook is comprised of one or more [Sheets](../blueprint/overview#terms) plus any actions you want to take on those Sheets.
...
#### `Fields` *array*
Sheets contain [Fields](../blueprint/overview#terms). Fields are defined properties of your schema (eg a first_name on a contact sheet.)
