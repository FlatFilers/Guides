...
Additional Actions can be mounted on Sheets, Workbooks, Spaces, and files. See the Actions guide.
...
#### Listener-created Jobs
Listeners can also be set up to react to Events and create new Jobs. 
