...
Jobs are then managed via [Listeners](/concepts/listeners), which receive [Events](/concepts/events) published by Flatfile when certain actions occur. 
...
You can listen on any of these events in your [Listener](/concepts/listener).
