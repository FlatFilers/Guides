...
<ParamField path="outcome" type="object" required>
  outcome:
</ParamField>
...
<ParamField path="managed" type="string" required>
...
// TODO Outcome types (acknowledge: true, and if it’s a tooltip or full screen takeover) + images
