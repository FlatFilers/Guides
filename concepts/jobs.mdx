...
|               |                                                                                          |
| ------------- | ---------------------------------------------------------------------------------------- |
| `filter`      | Definition of filtering conditions to apply to Job records.                              |
| `filterField` | The specific field upon which the filter should be applied.                              |
| `searchValue` | The value to be used in search operations within the Job’s dataset.                      |
| `searchField` | The field to be used as a reference point in search operations within the Job’s dataset. |
| `q`           |                                                                                          |
| `sheet`       | The unique identifier for the sheet within the Job context.                              |
| `exceptions`  | A list of record identifiers that should be excluded from the Job process.               |
