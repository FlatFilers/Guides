...
A Space is comprised of Workbooks, Files, Guests, Documents, Themes and Metadata.
...
#### `Theme` *object*
Theming of Flatfile is controlled at the Space level. A comprehensive list of Theme options is available [here](../guides/theming).
