...
#### `Theme` *object*
Theming of Flatfile is controlled at the Space level. A comprehensive list of Theme options are available <Tooltip tip="Learn how to customize your Space">[here](../guides/theming)</Tooltip>.
