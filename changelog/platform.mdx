    ...
    <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Decoupling Actions Updates from the Workbook's Schema**
        ...
        Previously, updating actions through our workbook update endpoint necessitated submitting all the fields, even for minor adjustments to an action. Now, with our improved `PATCH` endpoint, you can update actions without needing to include the `fields` property in your payload.
