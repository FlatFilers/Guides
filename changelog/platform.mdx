...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      ###### Download Files Made Easier
      
      Support has been aded in the job outcome modal for downloading files. When clicked, you'll immediately download your data.
      
      The `Jobs Panel` will also show your recent downloads.
    </div>
  </div>
</div>
