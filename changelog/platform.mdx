...
<div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Enhanced Visibility with Status Updates During File Extraction**
        ...
        [See extractor plugins](../plugins/extractors/)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
     ...
     **Next Action Links in Job Outcome Dialogs Now Support Linking to internal resources**
     ...
     ![image](../changelog/images/next_link.png)
      ...
      Job outcomes with next action links have been upgraded. Now, you can display links to an internal resource in addition to already being able to link to external URLs and trigger downloads upon job completion.

      In this code below, we will create a button that says “See all downloads” with this url: https://spaces.flatfile.com/space/us_sp_1234/files?mode=export
