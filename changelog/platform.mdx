...
### March 1, 2024
  ...
  <div style={{ display: "table", width: "auto" }}>
   ...
   <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Major Improvement in Load Speeds for Large Datasets**

        Previously, data imports automatically performed counts every 100 records. While comprehensive, this could slow down operations, particularly with larger datasets. Recognizing the impact on performance and user experience, record counts will now only occur upon explicit request. This change ensures a more streamlined and faster experience, allowing you to work with substantial volumes of data more effectively.
   ...
   <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Introducing `lastActivityAt` - Your Insight into Space Dynamics**
        ...
        We're thrilled to introduce a new attribute, `lastActivityAt`, designed to provide you with comprehensive insights into the activity within your Spaces. Here's what you need to know:
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Enhanced File Upload Experience: Multi-Selection and Drag-and-Drop Support**
        ...
        We've upgraded the Files View with new capabilities to significantly improve your file management workflow. Now, you can select and upload multiple files simultaneously through the File Uploader, streamlining the process.
...
<div style={{ display: "table", width: "auto" }}>
     ...
     **Enhanced Theming Tabs, Tooltips, and Popovers**
       ...
       We're excited to announce a broad range of new theming capabilities that significantly enhance the visual appeal and customization of our platform:
  ...
  <div style={{ display: "table-row", width: "auto" }}>
     ...
     **Enhanced Theming Interactive options**
     ...
     ![image](../changelog/images/theming_dropdowns.png)
       ...
       We're thrilled to introduce the latest updates in our theming capabilities, bringing a fresh look and enhanced customization to various UI elements:
