  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        Now, you can seamlessly view up to 500k records in your Sheet at once. As you scroll down to the bottom, a handy message will pop up to remind you that more data is available – just filter your results.
      </div>
