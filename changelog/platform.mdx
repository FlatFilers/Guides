...
<div style={{ display: "table", width: "auto" }}>
   ...
   <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Action State-Based Messaging with Tooltips**

        We've introduced an exciting new capability to enhance user interaction and feedback in our application. You can now add custom messages to disabled actions, tailored according to their state:
