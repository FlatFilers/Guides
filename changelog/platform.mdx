...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **Guests can now be named in Embedded Flatfile**

        Previously, accessing Flatfile either directly through a URL or via an iframe in an embedded SDK with an `accessToken` would categorize all user activities under an anonymous guest. Now, if you know the `guestId`, interactions in embedded Flatfile can be tied back to that person.
        ...
        With this method, Guests are now accurately named and identifiable in the Embedded Flatfile environment, enhancing user recognition and auditing.

        Note: If you were using [`userInfo`](https://flatfile.com/docs/guides/use-cases/embedding/reference/common#userinfo) to identify guests for this purpose, we suggest deprecating your usage and switching to this new approach.
