...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      api@97f8987
      Record order is now maintained when inserting records. When using the Flatfile API to add records, the order of those records will now be preserved keeping the original sequence as provided
    </div>
  </div>
</div>
