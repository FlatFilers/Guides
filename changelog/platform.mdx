...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      spaces-ui@e041aa4
      The title of the "Map Fields" section has been updated from "Map Fields" to "Map values". The subheading of this section remains unchanged, describing that this feature is for mapping field values to a list of valid options.
    </div>
  </div>
</div>
