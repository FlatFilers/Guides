...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    **Options at your fingertips:**
    ...
    To get started simplifying the management of your Jobs, explore the [README](../plugins/core/jobs-handler).
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      **@flatfile/util-extractor@0.3.0**
      ...
      This version introduces 2 new options for extracting records in all extractor plugins:
      ...
      **Ex: Excel Usage: (See [docs](../plugins/extractors/xlsx-extractor))**
      ...
      All extractor plugins use `@flatfile/util-extractor` under the hood. If you update your extractor plugin to the latest, you will receive these new options.
