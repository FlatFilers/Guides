...
<div style={{ display: "table", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      **🚀 Introducing @flatfile/plugin-convert-yaml-schema 🚀**
      ...
      Check out the [docs](https://flatfile.com/docs/plugins/schemas/convert-yaml-schema).
...
<div style={{ display: "table", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      **🚀 Introducing @flatfile/plugin-convert-json-schema 🚀**
      ...
      Check out the [docs](https://flatfile.com/docs/plugins/schemas/convert-json-schema).
