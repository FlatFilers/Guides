...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      - **Utilization of Shared Utilities**: The integration now utilizes the shared `@flatfile/embedded-utils` module. This change lays the groundwork for consistent properties to be shared across all Flatfile embedded Software Development Kits (SDKs), promoting standardization and ease of maintenance.
