...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
    ...
    The @flatfile/plugin-xml-extractor package has been updated to version 0.5.17. This version includes an update to one of its dependencies, @flatfile/util-extractor, which has been upgraded to version 1.0.0. This dependency update brings potential improvements and bug fixes to the XML parsing functionality. Additionally, there is a minor change to the parser.spec.ts test file, where the parseBuffer, findRoot, headersFromObjectList, and xmlToJson imports have been reordered, and a metadata property with an undefined value has been added to a test case object. These changes enhance the reliability and maintainability of the XML extraction plugin, providing a more robust experience for developers working with XML data in their applications.
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      The latest version 1.0.0 of the @flatfile/plugin-delimiter-extractor package introduces new features to support header selection. 
      Developers can now enable header selection, allowing the plugin to automatically detect and return letter headers (e.g. A, B, C) representing column indexes instead of using the row data as headers. 
      ...
      ```js
      const result = await parseBuffer(buffer, { headerSelectionEnabled: true }) 
      // result.sheets['Sheet1'].metadata = { rowHeaders: [5] }
      ```

      This powerful new header selection capability streamlines working with delimiter-separated data files lacking explicit column headers. Upgrade to take advantage of this handy feature today!
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      The release also includes an updated example demonstrating how to set up the dedupe action within a sheet configuration. 
      By providing clearer guidance and better error handling, this release enhances the developer experience when working with the dedupe plugin.
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      The latest release of the @flatfile/plugin-constraints package introduces new features and improvements.
      This update adds support for the new string-list and enum-list field types, allowing developers to work with these data types seamlessly within their applications.
      With this release, developers can expect enhanced functionality and a more robust experience when working with constraints in their projects.

      For example, developers can now define constraints that validate string-list and enum-list field types, providing greater flexibility and control over data validation processes.
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      `@flatfile/plugin-automap@0.3.2`

      The latest release of the @flatfile/plugin-automap package (version 0.3.2) brings an update to its dependency on the @flatfile/api package. Developers using this plugin can look forward to benefiting from the latest improvements and bug fixes in the @flatfile/api package. Additionally, this release ensures compatibility with the latest versions of other Flatfile packages by updating the development dependencies. Upgrade to this latest version to take advantage of the most recent enhancements and maintain seamless integration with the Flatfile ecosystem.
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      This gives developers more flexibility in how they handle the exported file. Additionally, this release updates some dependencies, improves error handling, and streamlines the build process using Rollup. Developers can now more easily integrate Excel export functionality with automatic file downloading in their applications.
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    <Snippet file="chips/extractors.mdx" />
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      `@flatfile/plugin-zip-extractor@0.5.2`

      This release enhances the @flatfile/plugin-zip-extractor package with better handling of async operations. 
      The zip extractor now utilizes the modern-async library to seamlessly extract zip files without any async issues, ensuring a smooth deployment experience. 
      Additionally, it introduces a new plugin job handler for improved job management and progress tracking during the extraction process.
      Developers can now expect reliable zip file extraction with detailed progress updates, making it easier to integrate this powerful functionality into their applications. 
      Upgrade today and unlock the full potential of efficient and reliable zip file extraction!
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    <Snippet file="chips/schemas.mdx" />
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      `@flatfile/plugin-convert-yaml-schema@0.1.4`

      The @flatfile/plugin-convert-yaml-schema package has been updated to convert YAML schemas to the Flatfile Blueprint format, enhancing validation and data preparation. The readme now includes detailed documentation and examples, and the package keywords have been updated for better discoverability. The plugin now relies on the latest version of @flatfile/plugin-convert-json-schema (0.2.4), making it easier to use YAML schemas in Flatfile integrations.
      ...
      listener.use(
        configureSpaceWithYamlSchema(
          [
            { sourceUrl: "http://example.com/person.yml", name: "Person Sheet" },
            { sourceUrl: "http://example.com/product.yml" },
          ],
          {
            workbookConfig: { name: "YAML Schema Workbook" },
            debug: true,
          },
      ...
      This example shows how to configure a Flatfile Space with multiple YAML schema sources, customize names, add actions, and provide a callback for additional processing.
    </div>
  </div>
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      The @flatfile/plugin-record-hook package has been updated to include readonly configurations for entire records or specific fields within a record. 
      This new feature gives you more control over how data is presented and modified in your application. 
      Setting a record as readonly prevents any changes from being made, while marking individual fields as readonly allows editing for the remaining fields. To utilize this functionality, simply call the new setReadOnly() method on a record instance, optionally passing in field keys to specify which fields should be readonly. 
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    <div style={{ float: "left", display: "table-column", paddingLeft: "30px", width: "calc(80% - 30px)" }}>
      ...
      For example, to enable debug logging and use a custom header detection algorithm:

      ```typescript
      import { parseBuffer } from '@flatfile/plugin-xlsx-extractor';
      ...
      const workbook = await parseBuffer(excelBuffer, options);
      ```
    </div>
  </div>
</div>
