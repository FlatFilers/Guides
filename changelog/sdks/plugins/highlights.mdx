...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    ...
    **Removal of Axios Dependency:** We’ve eliminated the Axios dependency in
    ...
    more in the docs](../../../plugins-docs/transform/record-hook).
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    ...
    **Enhanced Response Rejection Handling:** The integration of our response
    ...
    docs](../../../plugins-docs/export/webhook)
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    ...
    [README](../../../plugins-docs/core/job-handler).
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    ...
    Spaces, explore the [README](../../../plugins-docs/core/space-configure).
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    **🚀 Introducing `@flatfile/plugin-pdf-extractor`** Our latest
    ...
    docs](../../../plugins-docs/extractors/pdf-extractor)
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    **🚀 Introducing `@flatfile/@flatfile/plugin-dedupe`**
    ...
    docs](../../../plugins-docs/transform/dedupe)
  </div>
</div>
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    **🚀 Introducing `@flatfile/plugin-delimiter-extractor`** Introducing the
    ...
    docs](../../../plugins-docs/extractors/delimiter-extractor)
  </div>
</div>
