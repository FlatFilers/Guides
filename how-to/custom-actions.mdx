...
The executable code within an Action is compiled into a <Tooltip tip="Learn more about Blueprint">[Job](../concepts/jobs)</Tooltip> and can run asyncronously or immediately.
