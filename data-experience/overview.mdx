...
You can configure more specific methods of bulk error resolution using our [Action framework](https://flatfile.com/docs/guides/actions) that are specific to the nature of the data that you expect to see.
