...
<ParamField path="options.chunkSize" type="number" default="3000">
  Specifies the quantity of Records per chunk.
</ParamField>

<ParamField path="options.parallel" type="number" default="1">
  Determines how many chunks are processed simultaneously.
</ParamField>
