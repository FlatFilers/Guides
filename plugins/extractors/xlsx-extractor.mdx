...
<div className="grid sm:grid-cols-6 gap-x-6 flex" style={{alignItems: 'flex-middle', marginBottom: '-3em'}}>
  <div className="col-span-3">
    ...
    This plugin parses all Sheets in an XLSX file and extracts them into Flatfile with `@flatfile/api`.
    
    <strong class="text-primary dark:text-primary-light">INSTALL</strong><br/>
