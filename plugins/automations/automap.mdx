...
<ParamField path="accuracy" required type="string"></ParamField>

<ParamField path="debug" type="boolean"></ParamField>

<ParamField path="defaultTargetSheet" type="string"></ParamField>

<ParamField path="matchFilename" type="RegExp"></ParamField>

<ParamField path="onFailure" type="(event: FlatfileEvent) => void"></ParamField>

<ParamField path="targetWorkbook" type="string"></ParamField>
