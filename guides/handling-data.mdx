...
To delete a subset of records, you can use `api.records.delete`. This method takes in an array of record IDs and deletes them from the sheet.
...
For clearing an entire sheet of its records, set up a bulk delete job. This task will comprehensively wipe out every record on the specified sheet.
