...
- If Flatfile's cron event runs on January 2nd, any space created before January 1st (older than 2 days) will be expired. Any data that was uploaded to the space will be deleted.

### Last Activity Policy Example:

- Space last modified on January 1st.
- Policy set to 3 days.
- If Flatfile's cron event runs on January 4th, any space that hasn't been modified since January 1st (older than 3 days) will be expired. Any data that was uploaded to the space will be deleted.
