---
title: "Common"
description: "See the commongly used shared properties across embedded Flatfile."
icon: "atom-simple"
---
...
<ParamField path="spaceBody" type="object">
  ...
  Reference](https://reference.flatfile.com/docs/api/25e20c8ab61c5-create-a-space).
</ParamField>
