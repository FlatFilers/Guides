...
<CardGroup cols={2}>
  <Card
    ...
    href="https://github.com/FlatFilers/create-flatfile-javascript/advanced/README.md"
    icon="star"
  >
    Clone the create-flatfile-javascript example project in GitHub.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Start from scratch" href="../javascript/reuse_space">
