...
<Warning>
  ...
  option. This is inherited from the Environment. [Learn
...
Create a basic Express.js server that will retrieve your Space data from the Flatfile API.
...
### Part 5: Review your package.json

Make sure you have the following packages at minimum in your package.json.
