...
### 3. Start your event listener

When you click the Flatfile button in your platform, it initiates a job event that can be observed by an event listener. This listener, in turn, constructs your Space on the Flatfile server. You can start by using a predefined event listener, and modify your schema and actions as necessary in the future.
