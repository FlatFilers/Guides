...
Second thing to note is that the `publishableKey` and `environmentId` are coded into the button’s onclick as values you’ll need to pass into the flatfileOptions object in order to get this to run properly. You can obtain your publishable key and environment Id by logging into your Flatfile Dashboard [here](https://www.notion.so/New-Simplified-Docs-8a1303661a8b4a3096deafcd977a6523?pvs=21).
...
```jsx
// just working in the confines of the flatfileOptions object here
const flatfileOptions = {
          publishableKey,
          environmentId,
					sheet,
