...
Namespaces are most often set at the [Environment level](https://flatfile.stoplight.io/docs/api/20058726b7884-update-an-environment), then chosen via a dropdown menu in the UI when the Space is created.
