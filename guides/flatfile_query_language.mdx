...
FFQL queries can be passed to any <Tooltip tip="View API reference">[REST API](https://flatfile.stoplight.io/docs/api)</Tooltip> endpoint that supports the `q` parameter.
