...
<ParamField path="actionColor" type="string">
  The color used for Action buttons and text. This will default to a slightly lighter shade of the primary color. 
</ParamField>

<Info>Set the Action color to the same value as your Primary Color for a more streamlined look</Info>
