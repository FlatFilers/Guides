...
<Tip>
The sidebar and table will automatically inherit theming from your root variables! 
</Tip>

<ParamField path="fontFamily" type="string">The font family used throughout the application.</ParamField>
<ParamField path="buttonBorderRadius" type="string">The border radius all buttons.</ParamField>
...
<Info>
  You can override the default colors of sidebar below. If these are not set they will inherit from your root colors.
</Info>
...
<Info>
  You can override the default colors of table below. If these are not set they will inherit from your root colors.
</Info>
