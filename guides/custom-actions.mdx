...
Once a user has extracted and mapped data into a <Tooltip tip="Learn more about Sheets">[Sheet](../concepts/workbooks#sheets-array)</Tooltip>, it may be more efficient to run an operation on the entire dataset rather than making atomic transformations at the record- or field-level. For example:
