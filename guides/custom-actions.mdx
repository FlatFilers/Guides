...
Sheet-level Custom Actions are configured within a <Tooltip tip="A powerful DDL (Data Definition Language)...">[Blueprint](../concepts/workbooks#blueprint-object)</Tooltip>. 
