...
In this example, we create a Document when a file is uploaded, but you can also create Documents in response to any other Event. [Read more](./concepts/event) about the different Events you can respond to.
...
Then set up a listener for this Action to define what should happen in response to this Action. Read more about how to handle Actions in your listener [here](./actions#document-mounted).
