...
Documents are standalone webpages for your Flatfile <Tooltip tip="Learn more about Spaces">[Spaces](../concepts/spaces)</Tooltip>. They can be rendered from [Markdown syntax](https://www.markdownguide.org/basic-syntax/).
