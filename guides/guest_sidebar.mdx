...
Flatfile allows you to update your sidebar to hide/show certain elements via the <Tooltip tip="Are micro-applications...">[Space](../concepts/spaces)</Tooltip> endpoint.
