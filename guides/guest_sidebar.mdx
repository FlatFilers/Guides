...
<ParamField path="showGuestInvite" type="boolean">
  {" "}
  Determines if a guest can add see the Manage Guests section of the sidebare and add another guest to the Space.{" "}
</ParamField>
