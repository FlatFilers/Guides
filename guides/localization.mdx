...
<Info>
Set your translationsPath to the path to your **english JSON URL**. Don't have an english file? You can use any other language instead.
</Info>
<Tip>
...
await api.spaces.update(spaceId, {
  translationsPath: 'https://raw.githubusercontent.com/FlatFilers/Platform-Translations/main/locales/en/translation.json'
});
```
...
The same logic that applies to Actions also applies to your documents. 

<CodeGroup>
```jsx .../locales/en/translating.json
