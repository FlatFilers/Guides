...
<Info>
Set your translationsPath to the path to your **english JSON URL**. This should be the URL ending in `/locales/en/translation.json`. Don't have an english file? You can use any other language instead.
</Info>
