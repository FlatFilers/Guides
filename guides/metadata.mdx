...
Metadata on the enviornment level can be configured to to record details about your environment. This can be useful for developers to store information about their deployments and even the spaces and users active there.
