...
If multiple values are provided for defaultPage, it with prioritize in the following order: Sheet, workbook, document.

If multiple values are provided for defaultPage, the space redirect will prioritize in the following order: Sheet, workbook, document.
