...
1. The space component which has <Tooltip tip="Analogous to a database...">[Workbooks](../concepts/workbooks)</Tooltip>
2. <Tooltip tip="Anatomy of an Event...">[Events](../concepts/events)</Tooltip> which
   enables workbooks to have asynchronous and customizable jobs to happen either
   behind the scenes or be triggered upon user interaction.
...
The `useSpace` hook returns a Space component which has internal <Tooltip tip="Analogous to a database...">[Workbooks](../concepts/workbooks)</Tooltip>.
