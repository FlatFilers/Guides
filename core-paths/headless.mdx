...
### Upload files
Because of Flatfile's Event-driven architecture, it's easy to set up a <Tooltip tip="Are micro-applications...">[Space](../concepts/spaces)</Tooltip> as a destination for any incoming files. 
