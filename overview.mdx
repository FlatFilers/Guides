...
<CardGroup cols={3}>
  <Card title="record-hook" href="https://flatfile.com/plugins/plugin-record-hook" icon="npm">
    A concise syntax for running custom logic on individual data records.
  </Card>
    <Card title="autocast" href="https://flatfile.com/plugins/plugin-autocast" icon="npm">
