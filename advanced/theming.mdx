...
```ts 
const createSpace = await flatfile.spaces.create(spaceId, {
...
//listen for an event, and update your theme to be relevant
flatfile.on('space:created', (event) => {
...
<ParamField path="fontFamily" type="string">The font family used throughout the app.</ParamField>
