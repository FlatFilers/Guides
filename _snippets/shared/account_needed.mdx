...
To complete this tutorial, you'll need to retrieve your [Publishable
  key](../developer-tools/security/authentication#secret-and-publishable-keys) and your [Environment Id](../developer-tools/environment) from your `development` environment.
