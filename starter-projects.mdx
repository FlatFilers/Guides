...
<Card
  title="Localization"
  icon="language"
  href="https://github.com/FlatFilers/flatfile-docs-kitchen-sink/tree/main/typescript/localization/index.ts"
>
...
<CardGroup cols={2}>
  ...
  >
    Clone the Flatfile create-flatfile-vuejs embedded example.
  </Card>
  <Card
    title="AngularJs"
    icon="angular"
  ...
  >
    Clone the Flatfile create-flatfile-angular embedded example.
  </Card>
