...
<Note>
  ...
  Hook](https://flatfile.com/plugins/plugin-record-hook#additional-options) method that make
  `mode` unnecessary.
</Note>
...
<Note>
  If you're using React and want more ideas on how you can implement your listener code or add plugins, check out our full React documentation [here](/apps/embedding/react/components).
</Note>