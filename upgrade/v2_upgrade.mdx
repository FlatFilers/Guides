...
couple of new concepts like a [Job](/orchestration/jobs) and
[Listener](/apps/custom/meet-the-listener). While you don't need to learn about
...
<Note>
  ...
  [here](/apps/embedding/react/components).
</Note>
