...
After you send the API request, head over to your [Dashboard](https://dashboard.flatfile.com) to see your workbook and interact with it. 

<Info>You'll need to add your [publishable key](../security/authentication) to the `request` file to get authenticated. [Sign up](https://dashboard.flatfile.com/account/sign-up) if you haven't yet.</Info>
