  ...
  "sheets": [
    {
      ...
      "actions": [
        {
            "slug": "todogenerateJSON",
            "label": "todoGenerate JSON",
            "description": "todoGenerate a JSON file based off of the Data in this Sheet",
            "primary": true
        },
      ]
    }
...
Now that you have a workbook in your Dashboard and know how to use schemas in Flatfile, you can actually stop there if that solves your use case.
