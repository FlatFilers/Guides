...
<h2><small>1.1</small> Building your first Workbook</h2>

Flatfile supports using many different schema DDLs. If you have an existing schema, use plugins like
  [@flatfile/plugin-json-schema](hello.com), [@flatfile/plugin-sql-ddl](hello.com), [@flatfile/plugin-openapi](hello.com), [@flatfile/plugin-graphql](hello.com).
  
For this tutorial, we're going to create a simple schema using <Tooltip tip="Learn more about Blueprint">[Blueprint](../blueprint/overview)</Tooltip>. Quickly create a sample Workbook by running this curl API request in your terminal or you can all our API directly from our API reference Docs.
