...
Copy this command, replace "YOUR_SECRETS_KEY" with the credential you just fetched from your account, and run it in your terminal.
...
<Info>
  ...
  site [here](../quickstart/create-your-workbook).
</Info>
...
curl --request POST \
  ...
  --header 'Authorization: Bearer YOUR_SECRETS_KEY' \
