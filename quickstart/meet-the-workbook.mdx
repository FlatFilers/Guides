...
<Note>Whenever any data changes in a workbook, an event is triggered via `Event Hooks`. [Learn more](hello.com).</Note>
...
A sentence or two goes here about wrapping your Blueprint in a Workbook and authenticating your client.
