...
Each of these actions creates an [Event](../concepts/events). You can author code to listen and react to these events by performing tasks such as validating and transforming records, importing and joining data from other sources, and even offloading data processing to your own API.
...
4. Go back to your Flatfile workbook and make a few changes. For example try uploading a CSV and then importing the data to the workbook.
5. and then see how those events were written in your Repl.it Console
