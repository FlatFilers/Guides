...
Flatfile provides a number of handy [transformation & validation plugins](https://plugins.flatfile.com) to reshape the data. Explore open source validation plugins available like:
