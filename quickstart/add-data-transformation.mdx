...
Every single action you take in Flatfile triggers an [Event](../concepts/events). Listening to those events allows you to do everything from validating records to sending data to your API.
