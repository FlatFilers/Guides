...
<Info>If you haven't used your new Workbook yet, head over to your [Dashboard](https://dashboard.flatfile.com) and check it out.</Info>

As you were interactive with your new Workbook, you may have made some changes to data. Whenever any data changes (or is added) in a Workbook, an event is triggered via <Tooltip tip="Learn more about Events">[Event Hooks](../concepts/events)</Tooltip>. 

Using our powerful [@flatfile/listener](../core-libraries/listener) library, we can listen for events and respond to them.
...
For this tutorial, we will intervene the `record` event topic with a powerful plugin, [@flatfile/plugin-record-hook](https://www.npmjs.com/package/@flatfile/plugin-record-hook) and perform callback functions
