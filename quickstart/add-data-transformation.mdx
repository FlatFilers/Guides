...
After starting the code in repl.it, go back to your Contacts worksheet and add a new row with the First Name written in all capital letters. You should notice that when you take focus off of the First Name field, your transformation will run and convert the characters in your value to lower case.
...
After starting the code in repl.it, go back to your Contacts worksheet and modify a value of Email Address, making it an invalid email. You should notice that when you take focus off of the field, your validation will run and the worksheet user interface will display an error for the changed field.
