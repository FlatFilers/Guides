...
Each of these actions creates an [Event](../concepts/events). You can author code to listen and react to these events by performing tasks such as validating records or sending data to your own API.
