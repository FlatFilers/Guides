...
5. Finally return to your Repl.it Console to see how those events were logged
...
You now have a Repl.it example listener that is responding to record changes in your Workbook, and can perform simple data transformations and validations. Be sure to delete the Repl.it and the Workbook when you're finished with them for security purposes.
