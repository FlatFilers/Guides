...
Every action you perform in Flatfile triggers an [Event](../concepts/events). You can listen to these events to perform various tasks such as validating records and sending the data to your API.
...
Next, we will add an action that submits the data from this Sheet to your API.
