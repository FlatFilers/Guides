...
To this point, we've been hosting our listener code using Repl.it. While this enabled us to get up and running with Flatfile quickly, it is not representative of a full deployment. Next, you should <Tooltip tip="Learn about deploying Flatfile">[deploy your code](../developer-tools/deploying)</Tooltip>.
