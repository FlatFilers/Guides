...
1. Once you've updated your listener, run it in repl.it.
2. In your Workbook, click the submit action.
3. In webhook.site, look at the query log and observe that the webhook received a call from the listener code.
...
To this point, we've been hosting our listener code using repl.it. While this enabled us to get up and running with Flatfile quickly, it is not representative of a production deployment. Next, you should [deploy your code](../developer-tools/deploying).
