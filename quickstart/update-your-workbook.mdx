...
description: "To add an action to your Workbook, paste the cURL request on the right in your terminal or send the request directly from here by building out the sheet and fields in the Body tab."
