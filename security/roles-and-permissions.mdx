...
Administrator roles have full access to your accounts, including inviting additional admins to your account, and seeing developer keys.
...
Guest roles receive access via a magic link or a shared link depending on the [Environment](../developer-tools/environment) `guestAuthentication` type. Guests roles can invite other Guests unless you turn off this setting in the [Guest Sidebar](../advanced/guest_sidebar).
...
<Info>This role can only be configured using code.</Info>
