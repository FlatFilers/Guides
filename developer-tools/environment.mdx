...
<Tooltip tip="Learn more about Environments">
  [Environments](../developer-tools/environment)
</Tooltip> are isolated entities and are intended to be a safe place to create and
