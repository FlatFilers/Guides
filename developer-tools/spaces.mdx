...
### Learning Path
1. Start with [Core Concepts](../overview.mdx) to understand how Spaces fit into Flatfile
2. Learn about [Authentication](../developer-tools/security/authentication.mdx) to secure your Space
3. Explore [Workbooks](../apps/workbooks/overview.mdx) to handle data within your Space
4. Master [Events](../orchestration/events.mdx) to add interactivity
