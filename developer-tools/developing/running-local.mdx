...
The Flatfile CLI provides a suite of tools to help you develop and deploy [Listeners](/orchestration/listeners) to Flatfile.

Listeners are at the core of the Flatfile ecosystem, they are responsible for picking up on [Events](/orchestration/events) and responding to them accordingly.
