...
body {
  ...
  color: var(--color-text); //text color when text is present on the page where Flatfile button is embedded (text defined inside "index.html" file
  font-family: var(--text-font); //font style of the text that is on the page where Flatfile button is embedded (text defined inside "index.html" file
  font-size: var(--size-base); //font size of the text that is on the page where Flatfile button is embedded (text defined inside "index.html" file
  line-height: 1.5; //distance between the text that is on the page where Flatfile button is embedded and the Flatfile button itself
  margin: 0;
}
