...
<ParamField path="closeSpace" type="operation: string, onClose: (data: any) => void">
  ...
  [Learn More](#closespace)
</ParamField>

<ParamField path="error" type="(error: Error | string) => React.ReactElement">
  Error element to display if the component throws an error. 
...
<ParamField path="spaceInfo" type="ISpaceInfo">
  ...
  [Learn More](#spaceinfo)
</ParamField>

<ParamField path="iframeStyles" type="React.CSSProperties">
  Styles the iframe using CSS Properties. 
  
  [Learn More](#iframestyles)
</ParamField>

<ParamField path="themeConfig" type="IThemeConfig">
  Theme determining the look and feel of the Space. 
  
  [Learn More](#themeconfig)
</ParamField>

<ParamField path="sidebarConfig" type="ISidebarConfig">
  Options for show or hide various UI elements. 
  
  [Learn More](#sidebarconfig)
</ParamField>
...
<ParamField path="loading" type="React.ReactElement">
  Loading element to display while space loads. 
...
Find an example project in the Flatfile GitHub repository.
