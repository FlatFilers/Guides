...
Once our files are being automatically uploaded and extracted, we'll need to automate the mapping of our data to our destination schema. Our Automap Plugin will automatically map the data, matching based on configureable options.

<Snippet file="guides/plugins/automap.mdx" />

See our [Automap Guide](../guides/automap) for more information.
