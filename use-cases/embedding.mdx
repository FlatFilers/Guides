...
Depending on your package maanager, you can check your version in the terminal as follows.
If you use an older version, you'll need to upgrade before beggining with Flatfile Embeded React.
