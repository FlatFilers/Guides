---
title: "Simple"
description: "See the simple-mode properties across embedded Flatfile."
icon: "rabbit-running"
---
...
<ParamField path="spaceBody" type="object">
  ...
  Reference](https://reference.flatfile.com/api-reference/spaces/create-a-space).
</ParamField>
...
Flatfile has many different ways to handle and process data back to you once an import has happened, but the easiest in this context is the built-in `onSubmit` callback where the data is provided to you. Using this callback will add a button labelled "Submit" in the top right of your space for users to click on to initiate the record submission process. Due to the nature of this callback and button, it cannot be used with our [action constraints](../../../orchestration/actions#optional-parameters). 
