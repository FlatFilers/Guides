...
<CardGroup cols={2}>
  <Card
    ...
    href="https://platform.flatfile.com/dashboard/apps/portal/start"
    icon="star"
  >
    Download a working example after installing the Portal App.
  </Card>
  <Card
    title="Start from scratch"
    href="../javascript/new_space_quickstart"
    icon="pencil"
  >
...
Using Node and package.json, you'll setup a full localhost project end to end.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="star"
  >
    Clone this full Javascript example project in GitHub.
  </Card>
  <Card title="Start from scratch" href="../javascript/new_space" icon="pencil">
    Set up an embedded Flatfile Workbook from beginning to end.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    title="Start from a working example"
    icon="star"
    href="https://github.com/FlatFilers/create-flatfile-javascript/blob/main/advanced/README.md"
  >
    Clone this full Javascript example project in GitHub.
  </Card>
  <Card
