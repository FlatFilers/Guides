...
Listeners can be hosted anywhere. In this tutorial you've been hosting one on your your local machine. In production, you can [deploy](../../developer-tools/deploying) your listener directly on the Flatfile platform.
