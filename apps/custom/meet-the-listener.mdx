...
In Flatfile, an event-based system, that means an [Event](../../orchestration/events) was published.

A [Listener](/orchestration/listeners) is a function that is triggered by an Event. It's a powerful building block because it can be completely customized, enabling you to respond to events precisely the way your business and workflow requires.
...
Now that you've created a [Listener](/orchestration/listeners), a powerful building block on the Flatfile platform, let's learn how to leverage your listener to [Transform and validate data](../custom/add-data-transformation).
