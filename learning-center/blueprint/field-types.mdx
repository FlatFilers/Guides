...
<ParamField path="config.allow_custom" default="false" type="boolean">
  Permit the user to create new options for this specific field. When enabled, custom values will be allowed but will not be considered valid for validation purposes.
</ParamField>
