...
All fields in Flatfile are internally treated as strings regardless of their specified type. The type specification determines how the value should be validated, transformed, and displayed, but the underlying storage is always string-based.
