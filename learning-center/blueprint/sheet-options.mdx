...
<ParamField path="access" type="array">
  ...
  access controls](/documentation/blueprint/access).
</ParamField>
...
<ParamField path="fields" type="array" required>
  ...
  {""}
  Learn more about [Field types](/documentation/blueprint/field-types), [Constraints](/documentation/blueprint/constraints),
  and [Relationships](/documentation/blueprint/relationships).
</ParamField>
...
<ParamField path="constraints" type="array">
  ...
  {""}
  Learn more about [Constraints](/documentation/blueprint/constraints).
</ParamField>
