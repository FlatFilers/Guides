...
<CardGroup cols={2}>
  <Card title="Sheet Options" icon="table-list" href="/documentation/blueprint/sheet-options">
    Configure the basic behavior of your Sheet with Sheet-level options.
  </Card>
  <Card title="Field Types" icon="input-text" href="/documentation/blueprint/field-types">
    Learn about the different field types and how to use them.
  </Card>
  <Card
    title="Field Constraints"
    icon="list-check"
    href="/documentation/blueprint/constraints"
  >
    Learn about the available constraints and how they work.
  </Card>
  <Card title="Field Relationships" icon="link" href="/documentation/blueprint/relationships">
    Establish connections between Sheets and fields.
  </Card>
  <Card title="Access Control" icon="lock" href="/documentation/blueprint/access">
    Configure field, Sheet, and Workbook level user capabilities.
  </Card>
  <Card title="Treatments" icon="layer-group" href="/documentation/blueprint/sheet-options#treatments">
