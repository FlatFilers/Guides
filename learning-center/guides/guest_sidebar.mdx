...
Flatfile allows you to update your sidebar to hide/show certain elements via the <Tooltip tip="A micro-application...">[Space](../developer-tools/spaces)</Tooltip> endpoint.
