...
When merging a Data Clip, a visual diff of all changes allows users to confirm updates before they are applied. After a successful merge, you will be automatically redirected to the source sheet where you can see your merged changes.
