...
<Info>
When records are merged from a Data Clip back to the main sheet, any internal metadata specific to the Data Clip is not preserved. This ensures that the main sheet maintains clean data without carrying over temporary tracking information from the clip.
</Info>
