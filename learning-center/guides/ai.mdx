...
description: "use AI Assist to make bulk edits to your data efficiently and accurately"
icon: "microchip-ai"
---
...
Flatfile's assistant now provides intelligent, contextual recommendations to help you accomplish common tasks more efficiently. When you open the assistant in an empty space, you'll immediately see suggested actions based on your current context.

### Key Features

- **Contextual Suggestions**: The assistant analyzes your current workspace and provides relevant recommendations for next steps
- **One-Click Actions**: Select any recommendation to immediately execute that action or start a guided workflow
- **Confidence-Based Ranking**: Recommendations are prioritized based on relevance to your current task
- **Detailed Explanations**: Each recommendation includes a description of what it does and why it might be helpful

These AI-powered recommendations make Flatfile more intuitive for new users and more efficient for experienced users by reducing the need to manually search for or remember common operations.
