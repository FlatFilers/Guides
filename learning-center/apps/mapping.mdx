...
However, we have introduced a [Python SDK](/developer-tools/mapping-libraries/flatfile-mapping-python) that
 allows you to create your own mapping rules and mapping programs and apply them to your
