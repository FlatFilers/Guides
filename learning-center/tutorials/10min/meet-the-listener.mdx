...
[Event](../../orchestration/events) is published on almost any interaction a
user has within the Flatfile platform.

A [Listener](/orchestration/listeners) is a function that is triggered by an
...
[Configure a Space](../custom/meet-the-workbook) on the fly.
