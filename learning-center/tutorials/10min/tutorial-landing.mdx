...
<CardGroup cols={2}>
  <Card
    ...
    href="/learning-center/tutorials/10min/meet-the-listener"
    icon="circle-1"
  >
  ...
  <Card
    ...
    href="/learning-center/tutorials/10min/meet-the-workbook"
    icon="circle-2"
  >
  ...
  <Card
    ...
    href="/learning-center/tutorials/10min/add-data-transformation"
    icon="circle-3"
  >
    Process your data
  </Card>
  <Card
    ...
    href="/learning-center/tutorials/10min/submit-action"
    icon="circle-4"
  >
    Export your data
  </Card>
...
[Setup a Listener](/learning-center/tutorials/10min/meet-the-listener).
