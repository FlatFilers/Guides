...
Your data begins as file storage, where uploaded files are securely stored and encrypted at rest. After successful processing, these original files are automatically removed to maintain security and optimize storage space.

The processed data resides in Flatfile's database system, where each Space maintains its own isolated storage environment. All data in this permanent storage is encrypted and regularly backed up to ensure data safety and availability.
